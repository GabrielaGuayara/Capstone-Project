    ...
    return (
        ...
        <section className="py-5">
            <div className="container ">
                <Filterdata searchProducts={searchProducts} searchInp ={SearchInp} setProducts={setProducts} products={products}/>
                    { SearchInp.length >0 ? <div className="row text-center prod-cards ">
                            {filter.map((p,i)=>{
                                    return <div className= "card col-md-3 mx-10 details" key={i}>
                                            <h5 className="mt-3 text-uppercase fw-bold">{p.name}</h5>
                                            <img className="card-img-top" src={p.img} alt="perfume"/>
                                            <div className="card-body">
                                                        <div className="card-text">
                                                            <p className="fw-bold ">{ p.brand} </p>
                                                            <p> { p.descp}</p> 
